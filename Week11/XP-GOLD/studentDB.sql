...
-- SELECT * FROM students ORDER BY last_name, first_name ASC FETCH FIRST 4 ROW ONLY
-- SELECT MIN(birth_day) FROM students
SELECT * FROM students WHERE id>=3 FETCH FIRST 3 ROW ONLY