...
// Create a function getCarHonda(carInventory) that takes a 
// single parameter. carInventory‘s value is an array which 
// is an inventory of cars (see the array of objects below)
// The function should
...
function sortCarInventoryByYear(cars) {
    const ascending = cars.sort((a , b) => (a.car_year < b.car_year ? -1 : 1));
